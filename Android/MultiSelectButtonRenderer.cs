...
[assembly: ExportRenderer(typeof(MultiSelectButton), typeof(MultiSelectButtonRenderer))]
namespace Huntsman.Mobile.Droid
{
    public class MultiSelectButtonRenderer : ButtonRenderer
    {
        private GradientDrawable _normal, _pressed;
		private MultiSelectButton btn;
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Button> e)
        {
            ...
            if (Control != null)
            {
				...
				btn = e.NewElement as MultiSelectButton;
				...
				var highlight = Context.ObtainStyledAttributes(new int[] { Android.Resource.Attribute.ColorActivatedHighlight }).GetColor(0, Android.Graphics.Color.ParseColor(Globals.GREEN));
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (_normal != null && _pressed != null)
            {
				...
				{
					_normal.SetColor(Android.Graphics.Color.ParseColor(Globals.GREEN));
					_pressed.SetColor(Android.Graphics.Color.ParseColor(Globals.GREEN));
					//btn.TextColor = Color.FromHex("0xFFFFFF");
				}
				if (btn != null && !btn.IsBtnEnabled)
				{
					_normal.SetColor(Android.Graphics.Color.ParseColor(Globals.WHITE));
					_pressed.SetColor(Android.Graphics.Color.ParseColor(Globals.WHITE));
					//btn.TextColor = Color.FromHex("0x818181");
				}
            }
        }
    }
