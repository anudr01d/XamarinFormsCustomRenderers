...
[assembly: ExportRenderer(typeof(PopupSaveButton), typeof(PopupSaveButtonRenderer))]
namespace Huntsman.Mobile.Droid
{
	public class PopupSaveButtonRenderer : ButtonRenderer
	{
		private GradientDrawable _normal, _pressed;
		private PopupSaveButton btn;
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			if (_normal != null && _pressed != null)
			{
				...
				if (btn != null && btn.IsBtnEnabled)
				{
					...
					_normal.SetStroke((int)button.BorderWidth,Android.Graphics.Color.ParseColor(Globals.BLUE));
					_pressed.SetStroke((int)button.BorderWidth,Android.Graphics.Color.ParseColor(Globals.BLUE));
				}
				if (btn != null && !btn.IsBtnEnabled)
				{
					_normal.SetColor(Android.Graphics.Color.ParseColor(Globals.LIGHT_GRAY));
					_pressed.SetColor(Android.Graphics.Color.ParseColor(Globals.LIGHT_GRAY));
					_normal.SetStroke((int)button.BorderWidth,Android.Graphics.Color.ParseColor(Globals.LIGHT_GRAY));
					_pressed.SetStroke((int)button.BorderWidth,Android.Graphics.Color.ParseColor(Globals.LIGHT_GRAY));
				}
			}
		}
	}
